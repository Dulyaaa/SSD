...
export default class Home extends Component {
  ...
  getUser = (email) => {
    AuthService.getUser(email).then((response) => {
  ...
  sendToken = (userId, token) => {
    AuthService.sendToken(userId, token).then((response) => {
      if (response.status === 200) {
        this.props.history.push("/profile");
      }
    });
      ...
      <section class="block">
        <div class="left-p">
          ...
          <div class="text">
            ...
            <p>
              Power modern applications with enriched file uploading
              capabilities, message sending, added encryption features and more.
            </p>
          </div>
        </div>
        <div class="right-p">
          <div class="container">
            <div class="header">
              ...
              <p>
                Power modern applications with enriched file uploading
                capabilities, message sending, added encryption features and
                more.
              </p>
            </div>
